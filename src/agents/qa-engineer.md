...
As qa-engineer: surface `prediction-error` on FAIL verdicts whose root cause was structurally invisible to the test plan (visual defect, race condition, environmental quirk).
