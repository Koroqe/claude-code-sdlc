...
/** Parses the `model_for_role()` body into `(profile, role, model)` triples plus wildcard presence. */
...
function checkInstallTable(v, root) {
  ...
  const { triples, wildcardSeen } = parseInstallTable(body);
