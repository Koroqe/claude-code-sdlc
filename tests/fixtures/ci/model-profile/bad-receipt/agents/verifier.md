---
name: verifier
description: Fixture mirror of agents/verifier.md for scripts/ci/validate-model-profile.js's seeded-fixture tests (PRD Section 10, FR-10.4). Never installed, never shipped.
tools: ["Read"]
model: sonnet
effort: high
---
