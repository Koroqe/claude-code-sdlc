---
name: planner
description: Fixture mirror of agents/planner.md for scripts/ci/validate-model-profile.js's seeded-fixture tests (PRD Section 10, FR-10.4). Never installed, never shipped.
tools: ["Read"]
model: opus
effort: high
---
