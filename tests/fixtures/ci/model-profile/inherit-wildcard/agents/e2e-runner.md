---
name: e2e-runner
description: Fixture mirror of agents/e2e-runner.md for scripts/ci/validate-model-profile.js's seeded-fixture tests (PRD Section 10, FR-10.4). Never installed, never shipped.
tools: ["Read"]
model: inherit
effort: medium
---
