<!-- Fixture purpose: trips the "Wave 1 not tracer-only" BLOCKER check
     ...
     non-tracer slice, which must occupy Wave 1 alone. -->
...
|------|--------|----------------|-----------|
| 1    | 1, 3   | `src/routes/widgets.js`, `src/app.js`, `src/components/WidgetBadge.jsx` | Independent — no shared files |
| 2    | 2      | `src/data/widgets.js` | Depends on Wave 1's wiring |
